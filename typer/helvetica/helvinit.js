...
function createElement(k) {
  var elem = $('#container');
  if (k == "a" || k == "A") { elem.append('<div class="inner"><img src="images/a.png"></div>'); }
  if (k == "b" || k == "B") { elem.append('<div class="inner"><img src="images/b.png"></div>'); }
  if (k == "c" || k == "C") { elem.append('<div class="inner"><img src="images/c.png"></div>'); }
  if (k == "d" || k == "D") { elem.append('<div class="inner"><img src="images/d.png"></div>'); }
  if (k == "e" || k == "E") { elem.append('<div class="inner"><img src="images/e.png"></div>'); }
  if (k == "f" || k == "F") { elem.append('<div class="inner"><img src="images/f.png"></div>'); }
  if (k == "g" || k == "G") { elem.append('<div class="inner"><img src="images/g.png"></div>'); }
  if (k == "h" || k == "H") { elem.append('<div class="inner"><img src="images/h.png"></div>'); }
  if (k == "i" || k == "I") { elem.append('<div class="inner"><img src="images/i.png"></div>'); }
  if (k == "j" || k == "J") { elem.append('<div class="inner"><img src="images/j.png"></div>'); }
  if (k == "k" || k == "K") { elem.append('<div class="inner"><img src="images/k.png"></div>'); }
  if (k == "l" || k == "L") { elem.append('<div class="inner"><img src="images/l.png"></div>'); }
  if (k == "m" || k == "M") { elem.append('<div class="inner"><img src="images/m.png"></div>'); }
  if (k == "n" || k == "N") { elem.append('<div class="inner"><img src="images/n.png"></div>'); }
  if (k == "o" || k == "O") { elem.append('<div class="inner"><img src="images/o.png"></div>'); }
  if (k == "p" || k == "P") { elem.append('<div class="inner"><img src="images/p.png"></div>'); }
  if (k == "q" || k == "Q") { elem.append('<div class="inner"><img src="images/q.png"></div>'); }
  if (k == "r" || k == "R") { elem.append('<div class="inner"><img src="images/r.png"></div>'); }
  if (k == "s" || k == "S") { elem.append('<div class="inner"><img src="images/s.png"></div>'); }
  if (k == "t" || k == "T") { elem.append('<div class="inner"><img src="images/t.png"></div>'); }
  if (k == "u" || k == "U") { elem.append('<div class="inner"><img src="images/u.png"></div>'); }
  if (k == "v" || k == "V") { elem.append('<div class="inner"><img src="images/v.png"></div>'); }
  if (k == "w" || k == "W") { elem.append('<div class="inner"><img src="images/w.png"></div>'); }
  if (k == "x" || k == "X") { elem.append('<div class="inner"><img src="images/x.png"></div>'); }
  if (k == "y" || k == "Y") { elem.append('<div class="inner"><img src="images/y.png"></div>'); }
  if (k == "z" || k == "Z") { elem.append('<div class="inner"><img src="images/z.png"></div>'); }
  if (k == "1") { elem.append('<div class="inner"><img src="images/1.png"></div>'); }
  if (k == "2") { elem.append('<div class="inner"><img src="images/2.png"></div>'); }
  if (k == "3") { elem.append('<div class="inner"><img src="images/3.png"></div>'); }
  if (k == "4") { elem.append('<div class="inner"><img src="images/4.png"></div>'); }
  if (k == "5") { elem.append('<div class="inner"><img src="images/5.png"></div>'); }
  if (k == "6") { elem.append('<div class="inner"><img src="images/6.png"></div>'); }
  if (k == "7") { elem.append('<div class="inner"><img src="images/7.png"></div>'); }
  if (k == "8") { elem.append('<div class="inner"><img src="images/8.png"></div>'); }
  if (k == "9") { elem.append('<div class="inner"><img src="images/9.png"></div>'); }
  if (k == "0") { elem.append('<div class="inner"><img src="images/0.png"></div>'); }
}
